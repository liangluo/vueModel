<!--
 ...
 -->
<template>
  <div class="mod-skeleton animation-opacity columnapicture" v-if="skeloading">
    <div class="mod-skeleton-item cotctu-div" ></div>
  </div>
  <div class="columnapicture flex column" v-else-if="!!columnline">
    <div
      class="cotctu-div"
  ...
  <div class="columnapicture flex column" v-else>
