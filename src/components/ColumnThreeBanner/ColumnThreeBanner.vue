<!--
 ...
 -->
<template>
  <div class="mod-skeleton animation-opacity columnapicture flex f-wrap" v-if="skeloading">
    <div class="mod-skeleton-item cotctu-div" ></div>
    <div class="mod-skeleton-item cotctu-div" ></div>
    <div class="mod-skeleton-item cotctu-div" ></div>
  </div>
  <div class="columnapicture flex  f-wrap" v-else-if="!!columnline">
    <div
      class="cotctu-div"
  ...
  <div class="columnapicture flex f-wrap" v-else>
